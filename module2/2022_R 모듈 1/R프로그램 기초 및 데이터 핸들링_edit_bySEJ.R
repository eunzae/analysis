...
##----------------------------------------------------------
# Object Type - Vector # 한가지 값이 아니라 여러가지 값을 가질 때
...
library (readxl)
remission_xlsx = read_excel("/Users/eunjae/Desktop/analysis/module2/2022_R\ 모듈\ 1/remission.xlsx")
remission_xlsx
...
# 디렉토리 저장 없이 데이터 불러오기 
remission  <- read.csv ('/Users/eunjae/Desktop/analysis/module2/2022_R\ 모듈\ 1/remission.csv', header = TRUE)
...
setwd ('/Users/eunjae/Desktop/analysis/module2/2022_R\ 모듈\ 1/')
getwd () # 지정된 디렉토리 확인 
...
remission_order <- remission_merge [order(remission_merge$time) , ]  # remission_merge$time 오름차순
remission_order

remission_merge
remission_order1 <- remission_merge [order(-remission_merge$lWBC) , ]  # remission_merge$lWBC 내림차순
remission_order1
